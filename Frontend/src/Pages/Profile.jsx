    ...
    return (
        <main className="profile-page">
            <div className="profile-header">
                ...
                <h1>My Profile 👤</h1>
                <p>Manage your account settings and local seller details</p>
            </div>

            <div className="profile-grid">
                {/* Profile Information Form */}
                <div className="profile-card">
                    <h2>Personal & Shop Details</h2>

                    {profileMessage && <div className="profile-alert success">✓ {profileMessage}</div>}
                    {profileError && <div className="profile-alert error">⚠️ {profileError}</div>}
                ...
                <div className="profile-side-column">
                    <div className="profile-card">
                        ...
                        {passMessage && <div className="profile-alert success">✓ {passMessage}</div>}
                        {passError && <div className="profile-alert error">⚠️ {passError}</div>}
                        ...
                        <form onSubmit={handleChangePassword}>
                            ...
                            <button type="submit" className="pass-btn" disabled={changingPass}>
                    ...
                    <div className="profile-card quick-links-card">
                        ...
                        <div className="quick-links-list">
                            ...
                            {profileData.role === "seller" && (
                                <Link to="/add-product" className="quick-link seller">
                                    ➕ List New Product
                                </Link>
                            )}
                        </div>
